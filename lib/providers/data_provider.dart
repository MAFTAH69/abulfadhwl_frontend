...
import 'package:abulfadhwl_frontend/models/announcement.dart';
import 'package:abulfadhwl_frontend/models/answer.dart';
import 'package:abulfadhwl_frontend/models/question.dart';
import 'package:abulfadhwl_frontend/models/article.dart';
import 'package:abulfadhwl_frontend/models/book.dart';
import 'package:abulfadhwl_frontend/models/comment.dart';
import 'package:abulfadhwl_frontend/models/history.dart';
import 'package:abulfadhwl_frontend/models/link.dart';
import 'package:abulfadhwl_frontend/models/slide.dart';
import 'package:abulfadhwl_frontend/models/stream.dart';
...
// ********** ANNOUNCEMENTS DATA ***********
  ...
  Future<void> getAllAnnouncements() async {
    ...
    try {
      http.Response response = await http.get(api + 'announcements');
  ...
  Future<String> addQuestion({@required qn}) async {
    ...
    try {
      http.Response response = await http.post(api + 'question',
  ...
  Future<void> getAllAnswers() async {
    ...
    try {
      http.Response response = await http.get(api + 'answers');
  ...
  Future<void> getAllArticles() async {
    ...
    try {
      http.Response response = await http.get(api + 'articles');
  ...
  Future<void> getAllBooks() async {
    ...
    try {
      http.Response response = await http.get(api + 'books');
  ...
  Future<void> getAllHistories() async {
    ...
    try {
      http.Response response = await http.get(api + 'histories');
      if (response.statusCode == 200) {
        final Map<String, dynamic> data = json.decode(response.body);
  ...
  Future<void> getAllLinks() async {
    ...
    try {
      http.Response response = await http.get(api + 'links');
      if (response.statusCode == 200) {
        final Map<String, dynamic> data = json.decode(response.body);
  ...
  Future<void> getAllSlides() async {
    ...
    try {
      http.Response response = await http.get(api + 'slides');
      if (response.statusCode == 200) {
        final Map<String, dynamic> data = json.decode(response.body);
